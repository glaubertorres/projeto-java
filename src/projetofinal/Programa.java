...
public class Programa {
	...
	public static void main(String[] args) {
		...
		System.out.println(""
				...
				+ "\t##     ## ##   ### ##       ##    ##\r\n"
				+ "\t #######  ##    ## ########  ######\r\n");
		System.out.println("\nUNES é uma rede de apoio que conecta pessoas LGBTQIA+ com profissionais"
				+ "\nda saúde dedicados e preparados para oferecer atendimento humanizado de \n"
				+ "qualidade");
		
		System.out.println("\nVocê é uma pessoa LGBTQIA+ buscando atendimentou ou um profissional da "
				+ "\nsaúde que deseja se cadastrar em nosso banco de dados?");
		System.out.println("\n1 - ATENDIMENTO"
				+ "\n2 - CADASTRO");
		start = leia.nextInt();
